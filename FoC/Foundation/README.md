...
| `Reals.lean` | Dedekind-cut real numbers over quotient rationals, with rational embedding, order, density, arbitrarily small lower/upper cut approximants, cut addition/subtraction/multiplication, additive inverse and cancellation laws, multiplication commutativity, right distributivity, no-zero-divisor theorem, powers, rational scaling, embedded-rational division, arbitrary-real nonzero division by cancellation, concrete square-root cut candidates and square equalities for 2 and 3, and rational/irrational predicates plus square-characterization and square-equation irrationality bridges for book wrappers. |
