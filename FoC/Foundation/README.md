...
| `QuotientRationals.lean` | Quotient rational numbers over positive-denominator integer fractions, with arithmetic, order, density, countability, Archimedean step bounds, natural-fraction comparison helpers, explicit square-root approximants for 2 and 3, embeddings for Dedekind-cut reals, and no-square-root theorems for 2 and 3. |
| `Reals.lean` | Dedekind-cut real numbers over quotient rationals, with rational embedding, order, density, arbitrarily small lower/upper cut approximants, cut addition/subtraction/multiplication, additive inverse laws, powers, rational scaling, embedded-rational division, concrete square-root cut candidates and square equalities for 2 and 3, and rational/irrational predicates plus square-characterization and square-equation irrationality bridges for book wrappers. |
