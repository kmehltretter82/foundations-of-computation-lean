...
export EncodedRewriters.CanonicalLayouts.DovetailLayoutScanner
  ( BoolWordSuffixScannerDescription
    ...
    cellListSuffixScannerDescription_runConfig_canonical_false_suffix_inv_withRight
    ...
    cellSuffixScannerDescription_runConfig_encodeCellAppend_handoff_withRight
    ...
    natSuffixScannerDescription_runConfig_encodeNatAppend_handoff_withRight
    natSuffixScannerDescription_runConfig_nonblank_suffix_inv
    configurationSuffixScannerDescription_runConfig_code_handoff
    configurationSuffixScannerDescription_runConfig_canonical_false_suffix_inv_withRight
