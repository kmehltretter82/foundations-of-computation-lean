import FoC.Computability.Compiler.Core.EncodedRewriters.ClosedConfigRunner.Projection.Padded.TailCleanup.ScratchExtCountWindowPositioner
...
def selectedProjectionPaddedTailCleanupScratchCountRawSourceTapeWithExtraCountBlank
    (useAccept : Bool) (L : DovetailLayout) (extraScratch : Nat) :
    Tape Bool :=
  tapeAtCells [none]
    (List.append
