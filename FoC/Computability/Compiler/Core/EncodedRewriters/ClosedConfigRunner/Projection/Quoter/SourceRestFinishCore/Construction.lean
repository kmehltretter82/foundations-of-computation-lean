...
/-!
**Mixed parser-stack finisher target.**  The core finite-table obligation is
factored through a reusable source/target view.  The remaining concrete leaf
should prove the mixed parser-stack finisher construction below; the adapter
then turns it into the public left-boundary core without inspecting the
transition table.
-/
...
theorem
  ...
  rcases h with ⟨finish, hfinish⟩
  refine ⟨SeqViaCanonical MPSSR finish, ?_⟩
  constructor
  · exact
      SeqViaCanonical_subroutineReady
        mixedParserStackScanRightToStructuralBlankDescription_subroutineReady
...
theorem
  ...
  rcases h with ⟨finish, hfinish⟩
  refine
    ⟨SeqViaCanonical MPSDIM finish, ?_⟩
  constructor
  · exact
      SeqViaCanonical_subroutineReady
...
theorem
  ...
  rcases h with ⟨finish, hfinish⟩
  refine
    ⟨SeqViaCanonical MPSLB finish, ?_⟩
  constructor
  · exact
      SeqViaCanonical_subroutineReady
