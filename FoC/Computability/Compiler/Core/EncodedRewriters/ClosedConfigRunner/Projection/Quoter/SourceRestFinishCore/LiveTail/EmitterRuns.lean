...
/-!
# Source-rest live-tail emitter runs

This module contains the reusable scanner, tape-shape, and family contracts for
emitting the source-rest live tail.  The public live-tail wrapper re-exports
this local theory through its import surface.
-/
