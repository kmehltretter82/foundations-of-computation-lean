...
import FoC.Computability.Compiler.Core.EncRewriters.BoundedLayoutRunner.ConfigRunner.Basic
...
theorem AcceptMergePrimitive_transform_eq_some_cons
  ...
  rcases
      EncRewriters.dovetailLayout_encode_cons
        { L with
          acceptConfig := S.config
...
theorem parsedLayoutTape_move_left_move_right_configRunner
  ...
  rcases EncRewriters.dovetailLayout_encode_cons L with
    ⟨tail, htail⟩
