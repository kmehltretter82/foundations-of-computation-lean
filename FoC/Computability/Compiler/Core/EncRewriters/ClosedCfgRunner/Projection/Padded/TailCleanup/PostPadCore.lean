import FoC.Computability.Compiler.Core.EncRewriters.ClosedCfgRunner.Projection.Padded.TailCleanup.PostPaddingFramework
import FoC.Computability.Compiler.Core.EncRewriters.ClosedCfgRunner.Projection.Padded.TailCleanup.PostPaddingFieldEraser
...
import FoC.Computability.Compiler.Core.EncRewriters.ClosedCfgRunner.Projection.Padded.TailCleanup.PostPaddingRouteBridges

set_option doc.verso true

/-!
# Post-padding construction core

This module contains the sentinel target layouts, false-marker restoration,
rewind, and compaction bridge lemmas used by the post-padding closeout route.
The public post-padding construction module re-exports these facts through its
wrapper import.
-/
