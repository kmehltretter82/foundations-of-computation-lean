...
import FoC.Computability.Compiler.Core.EncRewriters.RightShifted
import FoC.Computability.Compiler.Core.EncRewriters.ClosedCfgRunner.PhaseRunner
import FoC.Computability.Compiler.Core.EncRewriters.ClosedCfgRunner.PaddedEmitters
import FoC.Computability.Compiler.Core.EncRewriters.ClosedCfgRunner.SelectedProjectionTailProjector
...
the padded/equivalence route used by the phase runner.
-/
...
/-!
Selected projection is phrased as a code-word emitter, with a checked
equivalence contract for the padded machine assembled by the phase runner.
-/
