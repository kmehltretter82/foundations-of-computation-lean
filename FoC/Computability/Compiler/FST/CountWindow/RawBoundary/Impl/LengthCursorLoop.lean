...
abbrev rawBoundaryLengthCursorStageNatBits (n : Nat) : Word Bool :=
...
theorem rawBoundaryLengthCursorDoneBits_eq :
...
theorem rawBoundaryLengthCursorStageNatBits_ne_nil
    (n : Nat) :
...
theorem rawBoundaryLengthCursorLoopDescription_run_donePrefix
    (emitted : Word Bool) (blankTail : Nat)
    (right : List (Option Bool)) :
    rawBoundaryLengthCursorLoopDescription.runConfig
        (2 * emitted.length + 10)
...
def rawBoundaryLengthCursorCursorTape
...
theorem rawBoundaryLengthCursorLoopDescription_run_cursorBootstrap
    (emitted : Word Bool) (blankTail : Nat)
    (right : List (Option Bool)) :
    rawBoundaryLengthCursorLoopDescription.runConfig
        (emitted.length + 10)
...
theorem rawBoundaryLengthCursorLoopDescription_step_cursorCheck_false
...
theorem rawBoundaryLengthCursorLoopDescription_run_carryFalse_to_anchor
...
theorem rawBoundaryLengthCursorLoopDescription_run_tickWriteFalse
    (right : List (Option Bool)) :
    rawBoundaryLengthCursorLoopDescription.runConfig 4
        { state := rawBoundaryLengthCursorLoopCarryFalse
          tape := tapeAtCells [] (none :: right) } =
...
theorem rawBoundaryLengthCursorLoopDescription_run_returnFalse_scanRight
    (bits : Word Bool) (left right : List (Option Bool)) :
    rawBoundaryLengthCursorLoopDescription.runConfig bits.length
        { state := rawBoundaryLengthCursorLoopReturnFalse
          tape := tapeAtCells left
...
theorem rawBoundaryLengthCursorLoopDescription_step_returnFalse_cursor
...
theorem rawBoundaryLengthCursorLoopDescription_run_advanceThree
...
theorem rawBoundaryLengthCursorLoopDescription_run_cursorCheck_noAnchor
