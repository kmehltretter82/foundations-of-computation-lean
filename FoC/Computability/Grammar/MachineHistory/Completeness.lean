...
namespace MachineDescriptionHistoryGrammar
 ...
 /-- {name}`leftGenerator_derives` captures the core lemma for this local construction. -/
theorem leftGenerator_derives (D : MachineDescription)
 ...
 /-- {name}`rightGenerator_derives` captures the core lemma for this local construction. -/
...
theorem start_derives_halting_config
 ...
 /-- {name}`reverse_step_derives` captures the core lemma for this local construction. -/
...
theorem reverse_run_derives (D : MachineDescription)
 ...
 /-- {name}`cleanup_tail_derives` captures the core lemma for this local construction. -/
theorem cleanup_tail_derives (D : MachineDescription)
 ...
 /-- {name}`cleanup_initial_derives` captures the core lemma for this local construction. -/
theorem cleanup_initial_derives (D : MachineDescription)
 ...
 /-- {name}`complete` captures the core lemma for this local construction. -/
theorem complete {D : MachineDescription} {w : Word Bool}
 ...
 /-- {name}`generated_language` captures the core lemma for this local construction. -/
