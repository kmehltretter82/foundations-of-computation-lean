...
namespace MachineDescriptionHistoryGrammar
 ...
 /-- {name}`lockedLeft_leftGenerator_yields` captures the core lemma for this local construction. -/
theorem lockedLeft_leftGenerator_yields {D : MachineDescription}
 ...
 /-- {name}`lockedLeft_headSelection_yields` captures the core lemma for this local construction. -/
theorem lockedLeft_headSelection_yields {D : MachineDescription}
 ...
 /-- {name}`lockedRight_rightGenerator_yields` captures the core lemma for this local construction. -/
theorem lockedRight_rightGenerator_yields {D : MachineDescription}
 ...
 /-- {name}`lockedRight_activation_yields` captures the core lemma for this local construction. -/
theorem lockedRight_activation_yields {D : MachineDescription}
 ...
 /-- {name}`historySoundForm_lockedLeft_yields` captures the core lemma for this local construction. -/
theorem historySoundForm_lockedLeft_yields {D : MachineDescription}
 ...
 /-- {name}`historySoundForm_lockedRight_yields` captures the core lemma for this local construction. -/
