...
-- Book: Chapter 4, Section 4.1, right-regular language vocabulary.
def RightRegularLanguage (L : Language terminal) : Prop :=
  CFG.RightRegularLanguage L

-- Book: Chapter 4, Section 4.1, left-regular language vocabulary.
def LeftRegularLanguage (L : Language terminal) : Prop :=
  CFG.LeftRegularLanguage L

-- Book: Chapter 4, Section 4.1, reversal grammar construction.
def ReverseGrammar (G : CFG terminal nonterminal) : CFG terminal nonterminal :=
  CFG.ReverseGrammar G

-- Book: Chapter 4, Section 4.1, the reversal grammar generates the reversed
-- language.
...
-- Book: Chapter 4, Section 4.1, finite production presentations are
-- preserved by reversal.
...
-- Book: Chapter 4, Section 4.1, CFL closure under reversal.
...
-- Book: Chapter 4, Section 4.1, left-regular grammars become right-regular
-- grammars under reversal.
...
-- Book: Chapter 4, Section 4.1, right-regular grammars become left-regular
-- grammars under reversal.
...
-- Book: Chapter 4, Section 4.1, left-regular languages are exactly the
-- languages whose reversals are right-regular.
...
-- Book: Chapter 4, Section 4.1, regular languages are generated by
...
-- Book: Chapter 4, Section 4.1, left-regular grammars generate regular
...
-- Book: Chapter 4, Section 4.1, left-regular grammar equivalence.
...
-- Book: Chapter 4, Section 4.1, Theorem 4.4, NFA-to-right-regular grammar.
...
-- Book: Chapter 4, Section 4.1, Theorem 4.4, regular languages are
-- generated by right-regular grammars.
theorem regular_languages_are_right_regular {L : Language terminal}
    (hL : RegularLanguage.Regular L) :
    RightRegularLanguage L :=
  CFG.regular_rightRegularLanguage hL

-- Book: Chapter 4, Section 4.1, Theorem 4.4, right-regular grammars generate
-- regular languages over an explicit finite alphabet list.
...
-- Book: Chapter 4, Section 4.1, Theorem 4.4.
