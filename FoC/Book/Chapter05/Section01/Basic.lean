...
The concrete stopped-decider to acceptor transformations live in the sibling
decider-to-acceptor page, so this page can be imported without pulling in the
transition-level scanner proofs.
-/
