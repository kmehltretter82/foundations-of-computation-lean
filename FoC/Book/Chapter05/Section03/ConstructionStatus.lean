...
finite contracts, the semantic valid-code checker, and these two negative
...
campaign. A halt-stable finite machine implementing the valid-code checker is
the next construction step toward that recognizer.
-/
