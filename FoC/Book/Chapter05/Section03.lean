...
finite tape-window artifacts. The remaining concrete work is the finite
universal-machine construction and the concrete diagonal-map computability or
decidable-preimage construction.
-/
