import FoC.Grammars.ParseTree.Pumping
...
/-!
# Derivation Traces and Ambiguity

Leftmost and rightmost derivation traces connect operational rewrite sequences to parse forests. The resulting correspondence characterizes grammar ambiguity by either distinct parse trees or distinct canonical left derivations.
-/
