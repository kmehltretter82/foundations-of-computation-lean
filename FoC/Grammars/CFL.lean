...
context-free language class. For generation by an arbitrary semantic grammar
without the finite-presentation witness, use {name}`CFG.GeneratedByCFG`
directly.
-/

/-- A language generated by a CFG whose production relation has a finite presentation. -/
def FiniteProductionContextFreeLanguage (L : Language terminal) : Prop :=
  exists nonterminal : Type, exists G : CFG terminal nonterminal,
    CFG.HasFinitePresentation G ∧ Language.Equal (CFG.GeneratedLanguage G) L

/-- The chapter's context-free language predicate, including finite presentation. -/
          ...
          | intro right hright =>
              ...
              | intro H hH =>
                  ...
                  · exact CFG.hasFinitePresentation_of_hasFiniteProductions
                      (CFG.union_hasFiniteProductions
                        (CFG.hasFiniteProductions_of_hasFinitePresentation hG.left)
                        (CFG.hasFiniteProductions_of_hasFinitePresentation hH.left))
                  · intro w
                    constructor
                    · intro hw
      ...
      | intro G hG =>
          ...
          | intro right hright =>
              ...
              | intro H hH =>
                  ...
                  constructor
                  · exact CFG.hasFinitePresentation_of_hasFiniteProductions
                      (CFG.concat_hasFiniteProductions
                        (CFG.hasFiniteProductions_of_hasFinitePresentation hG.left)
                        (CFG.hasFiniteProductions_of_hasFinitePresentation hH.left))
                  · intro w
                    constructor
...
theorem reverse_context_free {L : Language terminal}
  ...
  | intro nt hnt =>
      ...
      | intro G hG =>
          ...
          constructor
          · exact CFG.hasFinitePresentation_of_hasFiniteProductions
              (CFG.reverseGrammar_hasFiniteProductions
                (CFG.hasFiniteProductions_of_hasFinitePresentation hG.left))
          · intro w
            constructor
            · intro hw
...
theorem finiteProduction_generated_hasPumpingProperty
  ...
  have hFiniteProductions :=
    CFG.hasFiniteProductions_of_hasFinitePresentation hG
  let _ : DecidableEq nonterminal :=
    fun A B => Classical.propDecidable (A = B)
  cases CFG.finiteProductions_rhs_length_bound hFiniteProductions with
  | intro B hB =>
      let C := B + 1
